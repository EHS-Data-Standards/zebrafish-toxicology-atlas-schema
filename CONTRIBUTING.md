# Contributing to zebrafish-toxicology-atlas-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
zebrafish-toxicology-atlas-schema. These guidelines are not strict rules.
...
The zebrafish-toxicology-atlas-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the zebrafish-toxicology-atlas-schema technical leads
...
[issues]: https://github.com/sierra-moxon/zebrafish-toxicology-atlas-schema/issues/
[pulls]: https://github.com/sierra-moxon/zebrafish-toxicology-atlas-schema/pulls/
