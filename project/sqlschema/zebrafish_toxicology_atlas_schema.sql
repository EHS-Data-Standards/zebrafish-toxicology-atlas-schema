...
-- # Class: "Genotype" Description: "Represents a Genotype"
...
--     * Slot: name Description: A human-readable name for a thing
--     * Slot: description Description: A human-readable description for a thing
--     * Slot: GenotypeCollection_id Description: Autocreated FK slot
-- # Class: "GenotypeCollection" Description: "A holder for Genotype objects"
--     * Slot: id Description: 
...
CREATE TABLE "GenotypeCollection" (
	id INTEGER NOT NULL, 
	PRIMARY KEY (id)
);
CREATE TABLE "Genotype" (
	...
	name TEXT, 
	description TEXT, 
	"GenotypeCollection_id" INTEGER, 
	PRIMARY KEY (id), 
	FOREIGN KEY("GenotypeCollection_id") REFERENCES "GenotypeCollection" (id)
);