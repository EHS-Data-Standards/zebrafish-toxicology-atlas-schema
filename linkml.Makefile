...
SRC = src
DEST = project
PYMODEL = $(SRC)/zebrafish_toxicology_atlas_schema/datamodel
DOCDIR = docs
EXAMPLEDIR = examples
...
infores:
	$(RUN) gen-python src/zebrafish_toxicology_atlas_schema/schema/zebrafish_toxicology_atlas_schema.yaml > src/zebrafish_toxicology_atlas_schema/datamodel/zebrafish_toxicology_atlas_schema.py
